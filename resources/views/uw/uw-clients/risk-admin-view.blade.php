    ...
    <section class="content">
                                            ...
                                            @foreach($duplicateClients as $key => $value)
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-footer">
                                                        <a class="btn btn-primary btn-xs" id="getResultKATM" data-id="{{ $value->id }}">KATM</a>
                                                        <a class="btn btn-success btn-xs" id="getResultINPS" data-id="{{ $value->id }}">INPS</a>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
        ...
        <script>
            ...
            $(document).ready( function () {
                ...
                $('body').on('click', '#getResultKATM1', function () {
                ...
                $('body').on('click', '#getResultKATM', function () {
                    ...
                    let id = $('#getResultKATM').data('id');

                    $.ajax({
                        url: '/uw/get-client-res-k',
                        type: 'GET',
                        data: {id: id},
                        dataType: 'json',
                        beforeSend: function(){
                        ...
                        success: function(result){
                            console.log(result);
                            if (result.data.isVersion === 2){

                                let res = result.katm_data;
                                let data = '';
