            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <form action="{{ route('admin-menu_roles-search') }}" method="POST" role="search">
                            {{ csrf_field() }}
                            <div class="col-md-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <button type="button" class="btn btn-default btn-flat" onclick="location.href='/admin/menus_roles-search';">
        ...
        $('.editButton').unbind().on('click', function(){
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    // $('.edit-model-input-core_menu').val(res.core_menu)
                },
