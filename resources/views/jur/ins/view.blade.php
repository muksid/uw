                                    ...
                                    <div class="box box-solid">
                                        ...
                                        <div class="box-footer">
                                            <div class="form-group">
                                                    @switch($model->status)
                                                        @case(1)
                                                            <button id="sendToUwAdmin" value="{{ $model->id }}" class="btn btn-sm btn-bitbucket btn-flat">
                                                                <i class="fa fa-send"></i> Anderrayterga yuborish
                                                            </button>
                                                        @break
                                                        @case(2)
                                                        ...
                                                        @case(0)
                                                            ...
                                                            <button id="sendToUwAdmin" value="{{ $model->id }}" class="btn btn-sm btn-bitbucket btn-flat">
                                                                <i class="fa fa-send"></i> Anderrayterga qayta yuborish
                                                            </button>
                                                        @break
                                                    @endswitch
                                                        @if($modelComments)
            ...
            $("#getBalanceForm").click(function () {
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if (res.code === 500){
                            $("#overlayBalance").hide();
                            $('#resultMessage').html('code: '+res.code+' - '+res.errorMessage);
                            $('#resultModal').modal('show');
