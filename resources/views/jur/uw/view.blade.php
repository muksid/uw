...
@section('content')
    ...
    <section class="content">
                        ...
                        <div class="box box-widget widget-user-2">
                            <div class="widget-user-header bg-olive-active">
                                <div class="widget-user-image">
                                    <img class="img-circle" src="/images/jur_info_icon.png" alt="Uw Turon">
                                </div>
                                <h3 class="widget-user-username">YURIDIK MIJOZ MA`LUMOTLARI</h3>
                                <h5 class="widget-user-desc">Yuridik mijozlar</h5>
                            </div>
                            ...
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    <tbody>
                                    <tr>
                                        <td><strong>Tashkilot nomi:</strong></td>
                                        <td colspan="3">{{ $model->jur_name }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>STIR:</strong></td>
                                        <td>{{ $model->inn }}</td>
                                        <td><strong>IABS:</strong></td>
                                        <td>{{ $model->client_code }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Ariza #:</strong></td>
                                        <td>{{ $model->claim_id }}</td>
                                        <td><strong>Ariza sanasi:</strong></td>
                                        <td>{{ \Carbon\Carbon::parse($model->claim_date)->format('d.m.Y') }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>Tuman (shahar):</strong></td>
                                        <td>{{ $model->district->name??'-' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Manzili:</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <input id="branch_code" value="{{ $model->branch_code }}" hidden>
                                        <input id="client_code" value="{{ $model->client_code }}" hidden>
                                        <td><strong>BXO:</strong></td>
                                        <td>{{ $model->department->title??'-' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Inspektor:</strong></td>
                                        <td>{{ $model->user->personal->l_name??'-' }} {{ $model->user->personal->f_name??'-' }}</td>
                                        <td><strong>Lavozimi:</strong></td>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-primary box-solid">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">X/R pul aylanmasi</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="overlay" id="overlaySaldo">
                                ...
                                <div class="col-md-12">
                                    <div class="box box-solid">
                                        ...
                                        <div class="overlay" id="overlayOnlineReg">
                                            <i class="fa fa-refresh fa-spin"></i>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <div class="form-group">
                                                @if(!$model->katm_sir)
                                                <button type="button" class="btn bg-olive-active" id="onlineRegistration" value="{{ $model->id }}">
                                                    <i class="fa fa-globe"></i> KATM ga so`rov yuborish
                                                </button>
                                                @else
                                                    <h4 class="text-green"><i class="fa fa-check-circle-o"></i> Mijoz KATM dasturida ro`yhatdan o`tgan</h4>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-primary box-solid">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Skoring (КИАС) natijasi</h3>
                                        </div>
                                        <!-- /.box-header -->

                                        <div class="overlay" id="overlayKias">
                                            <i class="fa fa-refresh fa-spin"></i>
                                        </div>
                                        <div class="box-body no-padding">
                                            <div class="row">
                                        ...
                                        <div class="box-footer">
                                            <div class="form-group pull-right">
                                                <button class="btn btn-sm btn-primary btn-flat" id="getScoringKias" value="{{ $model->id }}">
                                ...
                                <div class="col-md-12">
                                    <div class="box box-danger direct-chat">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Kredit hujjat ma`lumotlari</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        @if($files)
                                            <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="box box-widget widget-user-2">
                            <div class="widget-user-header bg-blue-active">
                                <div class="widget-user-image">
                                    <img class="img-circle" src="/images/jur_res_icon.png" alt="Uw Turon">
                                </div>
                            ...
                            <div class="box-body no-padding">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>Kredit turi:</td>
                                        <td colspan="3"><strong>{{ $model->loanType->title??'-' }}</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Foiz:</td>
                                        <td colspan="2"><strong>{{ $model->loanType->procent??'-' }} %</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Davr:</td>
                                        <td colspan="2"><strong>{{ $model->loanType->credit_duration??'-' }} oy</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Imtiyozli Davr:</td>
                                        <td colspan="2"><strong>{{ $model->loanType->credit_exemtion??'-' }} oy</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Kredit Summasi:</td>
                                        <td colspan="2"><strong>{{ number_format($model->summa) }} so'm</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <div class="box box-solid">
                                        ...
                                        <div class="box-footer">
                                            <div class="form-group">
                                                @switch($model->status)
                                                    @case(2)
                                                    @foreach(Auth::user()->currentWork->roleId as $value)
                                                        @if($value->getRoleName->role_code === 'jur_uw')
        ...
        <div class="row">
            ...
            <!-- Modal -->
            <div class="modal fade modal-info" id="resultModal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title">So`rov natijasi</h5>
                        </div>
            ...
            <!-- Modal -->
            <div class="modal fade modal-info" id="tableModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="text-center">Buxgalteriya balansi 1 - sonli shakl</h4>
                        </div>
                        <div id="data_table_balance"></div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline" data-dismiss="modal">Close</button>
                        </div>
                    </div>
            ...
            <!-- Modal -->
            <div class="modal fade modal-info" id="tableFBalanceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="text-center">Moliyaviy natijalar to`g`risida xisobot 2 - sonli shakl</h4>
                        </div>
                        <div id="data_table_fbalance"></div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <form id="cancelForm" name="cancelForm">
                            <input type="hidden" name="jur_clients_id" id="jur_clients_id" value="{{ $model->id }}">
        ...
        <script>
            ...
            $("#sendToUwAdmin").click(function () {
                ...
                let po3060 = $("#paid_overdue_30_60_count").html();
                let po6090 = $("#paid_overdue_60_90_count").html();
                let po90 = $("#paid_overdue_90_count").html();
                let sc_b = $('#scoring_ball').html();

                if (po3060 > 0 || po6090 > 0 || po90 > 0){
                    $('#resultMessage').html('Просрочки от 30 до 90 дней и более');
                    $('#resultModal').modal('show');
                } else if (sc_b <= 200) {
                    $('#resultMessage').html('Scoring KIAS bali yetarli emas x < 200');
                    $('#resultModal').modal('show');
                } else {

                    let id = $('#sendToUwAdmin').val();

                    $.ajax({
                        url: '/jur/send-to-admin',
                        type: 'GET',
                        data: {id: id},
                        dataType: 'json',
                        success: function(res){
                            ...
                            if (res.code === 1){
                                ...
                                $('#sendToUwAdmin').html(res.message);
                            } else {
                                $('#resultMessage').html(res.message);
                                $('#resultModal').modal('show');
                            }
            ...
            $("#onlineRegistration").click(function () {

                let id = $('#onlineRegistration').val();
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function(){
                        $("#overlayOnlineReg").show();
                    },
                    success: function(res){
                        console.log(res);
                        $('#resultMessage').html(res.message+' - '+res.data);
                        $('#resultModal').modal('show');
            ...
            $("#getScoringKias").click(function () {

                let id = $('#getScoringKias').val();

                $.ajax({
                    url: '/jur/get-scoring-kias',
                    type: 'GET',
                    data: {id: id},
                    dataType: 'json',
                    beforeSend: function(){
                    ...
                    success: function(res){
                        console.log(res)
                        if (res.code === '05000'){
                            let base64 = atob(res.data.json_data);

                            let arr = JSON.parse(base64);
                            console.log(res);
                            let data = '<table class="table table-striped"><tbody>';
                            ...
                            data+='<tr>' +
                                ...
                                '<td colspan="2"><strong>Scoring bali:</strong></td>' +
                                    '<td colspan="2" class="text-green"><i class="fa fa-line-chart"></i> '+res.data.scoring_ball+'</td></tr><tr>' +
                                    '<td colspan="2"><strong>Yangilangan Sana:</strong></td>' +
                                    '<td colspan="2">'+formatDate(res.data.updated_at)+'</td>' +
                                '</tr>';
                            data+= '</tbody></table>';

                            data+='<button type="button" class="btn btn-sm bg-purple margin" id="getKIASModal" value="'+id+'">Ko`proq..</button>';
                            ...
                            $('#resultMessage').html('code: '+res.message+' - '+res.data);
                            $('#resultModal').modal('show');
                        }
            ...
            $('#showBalanceForm').click(function () {
                $('.showBalanceForm').toggle();

            });

            $("#getBalanceModal").click(function () {

                let id = $('#getBalanceModal').val();

                $.ajax({
                    url: '/jur/get-balance-modal',
                    type: 'GET',
                    data: {id: id, type : 'b'},
                    dataType: 'json',
                    beforeSend: function(){
                        $("#overlayBalance").show();
                        $("#data_table_balance").empty();
                    },
                    success: function(res){
                        ...
                        data+= '<tr>' +
                            '<th>#</th>' +
                            '<th>Satr kodi</th>' +
                            '<th>Hisobot davri boshiga</th>' +
                            '<th>Hisobot davri oxiriga</th>' +
                            '</tr>';
                        for (let i = 0; i < res.child.length; i++) {
                            ...
                            data+=
                                '<tr>' +
                                    '<td>'+num+++'.</td>' +
                                    '<td><span class="badge bg-info">'+val.row_no+'</span></td>' +
                                    '<td>'+val.sum_begin_period+'</td>' +
                                    '<td>'+val.sum_end_period+'</td>' +
                                '</tr>';

                        }
                        data+= '</tbody></table>';

                        $("#data_table_balance").html(data);

                        $('#tableBalanceModal').modal('show');
            ...
            $("#getBalanceForm").click(function () {

                let id = $('#getBalanceForm').val();
                let year = $('#year').val();
                let quarter = $('#quarter').val();

                $.ajax({
                    url: '/jur/get-balance-form',
                    type: 'GET',
                    data: {id: id, year : year, quarter : quarter, type : 'b'},
                    dataType: 'json',
                    beforeSend: function(){
                        $("#overlayBalance").show();
                        $("#data_balance").empty();
                    ...
                    success: function(res){
                        ...
                        if (res.code === 500){
                            $("#overlayBalance").hide();
                            $('#errorMessage').html('code: ('+res.code+') - '+res.errorMessage);
                            ...
                            let data = '';
                            data+= '<table class="table table-striped"><tbody>';
                            data+= '<tr>' +
                                '<td><strong>Tashkilot Nmi:</strong></td>' +
                                '<td colspan="3">'+value.company_name+'</td>' +
                                '</tr>' +
                                '<tr>' +
                                '<td colspan="2"><strong>STIR:</strong></td>' +
                                '<td colspan="2">'+value.tin+'</td>' +
                                '</tr>' +
                                '<tr>' +
                                '<td><strong>ns10_code:</strong></td>' +
                                '<td>'+value.ns10_code+'</td>' +
                                '<td><strong>Yil:</strong></td>' +
                                '<td>'+value.year+' - yil</td>' +
                                '</tr>' +
                                '<tr>' +
                                '<td><strong>ns11_code:</strong></td>' +
                                '<td>'+value.ns11_code+'</td>' +
                                '<td><strong>Kvartal:</strong></td>' +
                                '<td>'+value.quarter+' - chorak</td>' +
                                '</tr>' +
                                '<tr>' +
                                '<td colspan="2"><strong>Yangilangan vaqti:</strong></td>' +
                                '<td colspan="2">'+formatDate(value.created_at)+'</td>' +
                                '</tr>';
                            data+= '</tbody></table>';

                            data+='<button type="button" class="btn btn-sm bg-purple margin" id="getBalanceModal" value="'+id+'">Ko`proq..</button>';

                            $("#data_balance").prepend(data);

                        } else if (res.data.code === '05000'){
                            let value = res.data.report.data;
                            ...
                            data+= '<tr>' +
                                ...
                                '</tr>' +
                                '<tr>' +
                                '<td colspan="2"><strong>ns10_code:</strong></td>' +
                                '<td colspan="2">'+value.ns10_code+'</td>' +
                                '</tr>'+
                                '<tr>' +
                                '<td colspan="2"><strong>ns11_code:</strong></td>' +
                                '<td colspan="2">'+value.ns11_code+'</td>' +
                                '</tr>';
                            data+= '</tbody></table>';
                            ...
                            $('#errorMessage').html('code: ('+res.data.result+') - '+res.data.resultMessage);
                            $('#errorModal').modal('show');
                        }
            ...
            $("#getFBalanceForm").click(function () {

                let id = $('#getFBalanceForm').val();
                let year = $('#fyear').val();
                let quarter = $('#fquarter').val();

                $.ajax({
                    url: '/jur/get-balance-form',
                    type: 'GET',
                    data: {id: id, year : year, quarter : quarter, type : 'fb'},
                    dataType: 'json',
                    beforeSend: function(){
                        $("#overlayFBalance").show();
                        $("#data_fbalance").empty();
                    },
                    success: function(res){
                        console.log(res);
                        if (res.code === 500){
                            ...
                            data+='<button type="button" class="btn btn-sm bg-purple margin" id="getFBalanceModal" value="'+id+'">Ko`proq..</button>';
            ...
            $("#getFBalanceModal").click(function () {

                let id = $('#getFBalanceModal').val();
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        data+= '<tr>' +
                                    '<th rowspan="2">#</th>' +
                                    '<th rowspan="2">Satr kodi</th>' +
                                    '<th colspan="2">O`tgan yilning shu davrida</th>' +
                                    '<th colspan="2">Hisobot davrida</th>' +
                                '</tr>' +
                                '<tr>' +
                        ...
                        for (let i = 0; i < res.child.length; i++) {
                            ...
                            data+=
                                ...
                                '<td>'+num+++'.</td>' +
                                '<td><span class="badge bg-info">'+val.row_no+'</span></td>' +
                                '<td>'+val.sum_old_period_doxod+'</td>' +
                                '<td>'+val.sum_old_period_rasxod+'</td>' +
                                '<td>'+val.sum_period_doxod+'</td>' +
                                '<td>'+val.sum_period_rasxod+'</td>' +
                                '</tr>';

                        }
                        data+= '</tbody></table>';

                        $("#data_table_fbalance").html(data);

                        $('#tableFBalanceModal').modal('show');
            ...
            $("#getSaldo").click(function () {
                ...
                $.ajax({
                    url: '/jur/get-jur-saldo',
                    type: 'GET',
                    data: {id: id, filial: branch_code, code: client_code},
                    dataType: 'json',
                    beforeSend: function(){
                        $("#overlaySaldo").show();
                        $("#data_saldo").empty();
                    ...
                    success: function(res){
                        ...
                        if (res.length !== 0){
                            ...
                            data+=
                                '<tr>' +
                                '<td colspan="7" class="text-maroon text-center">Mijoz X/R bo`yicha pul aylanmasi topilmadi!!!</td>' +
                                '</tr>';
                        }
                        data+= '</tbody></table>';
