                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach ($models as $key => $model)
                                <tr ID="rowId_{{ $model->id }}">
                                    ...
                                    <td class="text-green text-sm">{{ $model->local_code }}</td>
                                    <td class="text-green text-sm">{{ $model->code_header }}</td>
                                    <td>{{ $model->title }}</td>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('body').on('click', '#editFilial', function () {
                    ...
                    $.get('/madmin/filial/' + model_id, function (data) {
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                model +=
                                    '<td class="text-center">' +
                                    '<button type="button" class="btn btn-xs btn-primary" id="viewFilial" data-id="' + data.id + '">' +
