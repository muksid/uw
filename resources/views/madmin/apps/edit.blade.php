    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form id="createForm" method="POST" action="{{ url('/madmin/app/'.$model->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="create_title">Title</label>
                                <input type="text" class="form-control" id="create_title" name="title" aria-describedby="emailHelp" placeholder="Templete title ..." value="{{$model->title}}" required>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="create_type" name="type">
                                        ...
                                        <option value="P" {{($model->type =='P') ? 'selected':''}}>Phy</option>
                                        <option value="J" {{($model->type =='J') ? 'selected':''}}>Jur</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="create_status_active" value="A" {{($model->status =='A') ? 'checked':''}}>
                                <label class="form-check-label" for="create_status_active">
                                    Active
                                </label>
                                <input class="form-check-input" type="radio" name="status" id="create_status_passive" value="P" {{($model->status =='P') ? 'checked':''}}>
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"  class="text create_body" id="editor1" name="body" required>{!! $model->body !!}</textarea>
                                    </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                let client_type = $('#create_type').val();
