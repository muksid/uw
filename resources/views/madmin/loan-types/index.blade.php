    ...
    <script>
        $(document).ready( function () {
            ...
            $('body').on('click', '.edit-post', function () {
                ...
                $.get('/madmin/loan-types/'+post_id+'/edit', function (data) {
                    $('#name-error').hide();
                    $('#email-error').hide();
        ...
        $('body').on('click', '#banks-post', function (e) {
            ...
            $.ajax(
                {
                    type: "GET",
                    url: "{{ url('/madmin/get-loan-banks') }}/"+id,
                    beforeSend: function(){
                        $("#loading").show();
                        $("#filialsData").empty();
                        $("#exp").empty();
