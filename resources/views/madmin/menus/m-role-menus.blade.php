            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <form action="{{ url('/madmin/role-menus-search') }}" method="POST" role="search">
                            {{ csrf_field() }}
                            <div class="col-md-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <button type="button" class="btn btn-default btn-flat" onclick="location.href='/madmin/role-menus';">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#edit-role_id').on("select2:select", function (e) {
                ...
                $.ajax({
                    url: '/madmin/role-menus/user-role/'+selectedValue,
                    type: 'GET',
