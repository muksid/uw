                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="box-header">
                            <div class="col-md-1">
                                <a href="{{ route('uw-guar-type.create') }}" class="btn btn-flat btn-info">
                                ...
                                @foreach($models as $key => $model)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('uw-guar-type.edit', $model->id) }}" class="btn btn-xs btn-info">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <form action="{{ route('uw-guar-type.destroy', $model->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
