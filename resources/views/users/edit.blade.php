...
@section('content')
    ...
    <section class="content">
        ...
        <form id="editForm" method="POST" action="{{ url('/admin/users-update') }}" role="form">
        ...
        <script src="{{ asset('/js/bootstrap-validator 0.11.9/validator.min.js') }}"></script>
        <script src="{{ asset('/js/bootstrap-validator 0.11.9/validator.js') }}"></script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    url: '/admin/work-users/get-history/'+user_id,
                    type: 'GET',
                ...
                $.ajax({
                    url: '/admin/work-users/get-roles/'+user_id,
                    type: 'GET',
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    success: function(res){
                ...
                $('#username').keyup(function() {
                    ...
                    if(username != current_username && username.length > 3){
                        ...
                        $.ajax({
                            ...
                            url: '/admin/users-username-check/'+username,
                            type: 'GET',
                            data: {_token: CSRF_TOKEN},
                            dataType: 'JSON',
                            success: function(res){
                ...
                $('#email').keyup(function() {
                    ...
                    if(email != current_email && email.length > 3){
                        $.ajax({
                            ...
                            url: '/admin/personal-users-email-check/'+email,
                            type: 'GET',
                            data: {_token: CSRF_TOKEN},
                            dataType: 'JSON',
                            success: function(res){
            ...
            $('#userHistoryTableBody').on('click', '.rolesHistory','button', function(){
                ...
                $.ajax({
                    url: '/admin/work-users/get-history-roles/'+id,
                    type: 'GET',
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    success: function(res){
            ...
            $('.activateUserConfirmed').click(function() {
                ...
                $.ajax({
                    url: '/admin/work-users/activate-user/'+id,
                    type: 'GET',
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    beforeSend: function () {
