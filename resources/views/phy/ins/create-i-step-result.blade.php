...
@section('content')
    ...
    <section class="content">
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td>1.</td>
                                                <td>Kredit turi</td>
                                                <td class="text-bold"><i class="fa fa-desktop"></i> {{ $model->loanType->title ?? '' }}</td>
                                                <td>
                                                    <i class="fa fa-check-circle text-info"></i>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-md-12">
                                    <div class="box-body">
                                        <div class="box-header with-border">
                                            <div class="col-md-12">
                                                @if($model->status == 0 || $model->status == 1)
                                                    <a href="javascript:void(0)" class="btn btn-info" id="create-file"><i class="fa fa-plus-circle"></i> Ilova hujjatlar</a>
                                                @else
                                                    Ilova hujjatlari
                                                @endif
                                            </div>
        ...
        <div class="modal fade" id="debtor-modal" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="debtorTitle"></h4>
                    </div>
                    <div class="modal-body">
                        <form id="debtorForm" name="debtorForm">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="debtor-btn-save" value="create"><i class="fa fa-save"></i> Saqlash</button>
                            </div>
        ...
        <div class="modal fade" id="guar-modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="guarTitle"></h4>
                    </div>
                    <div class="modal-body">
                        <form id="postGuarForm" name="postGuarForm">
                            <input type="hidden" name="guar_id" id="guar_id">
                            <input type="hidden" name="model_id" id="model_id" value="{{ $model->id }}">
                            <div class="row">
                                <div class="col-sm-12">
                                    <!-- text input -->
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="guar_title" name="title" value="" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <!-- text input -->
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Bekor qilish</button>
                                <button type="submit" class="btn btn-primary" id="guar-btn-save" value="create"><i class="fa fa-save"></i> Saqlash</button>
                            </div>
        ...
        <!-- DELETE GUAR modal -->
        <div id="ConfirmGuarModal" class="modal fade modal-danger" role="dialog">
            <div class="modal-dialog modal-sm">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                    ...
                    <div class="modal-footer">
                        <center>
                            <button type="button" class="btn btn-outline pull-left"
                                    data-dismiss="modal">@lang('blade.cancel')</button>
                            <button type="button" class="btn btn-outline" id="yesGuarDelete"
                                    value="create">Ha, O`chirish
                            </button>
                        </center>
                    </div>
        ...
        <!-- create FILE modal -->
        <div class="modal fade" id="file-modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" id="postFileForm" name="postFileForm">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Bekor qilish</button>
                                <button type="submit" class="btn btn-primary" id="file-btn-save" value="create"><i class="fa fa-save"></i> Saqlash</button>
                            </div>
            ...
            <div class="modal-dialog modal-lg" style="width: 1100px">
                <div class="modal-content">
                    <div class="modal-header bg-aqua-active">
                        ...
                        <h4 class="modal-title text-center" id="success">Scoring KIAS natijasi</h4>
                    </div>
        ...
        <script>
            ...
            $(document).ready( function () {
                ...
                $('body').on('click', '#confirmSendToAdmin', function () {
                    ...
                    $.get('/phy/get-confirm-send/' + id, function (response) {
                        //console.log(response);
                        if(response.status === 1)
                        {
                            $('#btn-save-send').val("sendLoan");
                ...
                $('#create-debtor').click(function () {
                    $('#debtor-btn-save').val("create-debtor");
                    $('#debtor_id').val('');
                ...
                $('body').on('click', '.edit-debtor', function () {
                    ...
                    $.get('/phy/client-debtors/'+debtor_id+'/edit', function (data) {
                        console.log(data);
                        $('#debtorModal').html("Qo`shimcha qarzdor ma`lumotlarini yangilash");
                        $('#debtor-btn-save').val("edit-debtor");
                        $('#debtor-modal').modal('show');
                ...
                $('#yesDebtorDelete').click(function () {
                    ...
                    let id = $('#ConfirmDebtorModal').data('id');

                    $.ajax(
                        {
                            type: "DELETE",
                            url: "{{ url('/phy/client-debtors') }}/"+id,
                            beforeSend: function(){
                                $("#loading-gif").show();
                            },
                            success: function (data) {
                ...
                $('#guar_datatable').DataTable({
                    ...
                    bInfo: false,
                    ajax: {
                        url: "{{ url('/phy/client/get-guars', ['id' => $model->id]) }}",
                        type: 'GET',
                    },
                    columns: [
                ...
                $('#create-guar').click(function () {
                    $.get('/madmin/get-guar-types', function (res) {
                        //console.log(res)
                        let data = '';
                        ...
                        $('#guar-btn-save').val("create-guar");
                        $('#guar_id').val('');
                        $('#postGuarForm').trigger("reset");
                        $('#guarTitle').html("Ta`minot kiriting");
                ...
                $('body').on('click', '.edit-guar', function () {
                    ...
                    $.get('/phy/client/edit-guar/'+id, function (data) {
                        $('#guarTitle').html("Ta`minot ma`lumotlarini yangilash");
                        $('#guar-btn-save').val("edit-guar");
                        $('#guar-modal').modal('show');
                        $('#guar_id').val(data.model.id);
                        $('#guar_title').val(data.model.title);
                            let arr = '';
                ...
                $('body').on('click', '#delete-guar', function (e) {

                    e.preventDefault();
                    var id = $(this).data("id");

                    $('#ConfirmGuarModal').data('id', id).modal('show');
                });

                $('#yesGuarDelete').click(function () {

                    let id = $('#ConfirmGuarModal').data('id');

                    $.ajax(
                        {
                            type: "GET",
                            url: "{{ url('/phy/client/delete-guar') }}/"+id,
                            beforeSend: function(){
                                $("#loading-gif").show();
                            },
                            success: function (data) {
                ...
                $('#file_datatable').DataTable({
                    ...
                    bInfo: false,
                    ajax: {
                        url: "{{ url('/phy/client/get-files', ['id' => $model->id]) }}",
                        type: 'GET',
                    },
                    columns: [
                ...
                $('#create-file').click(function () {
                    $('#file-btn-save').val("create-file");
                    $('#post_file_id').val('');
                    $('#postFileForm').trigger("reset");
                    $('#fileTitle').html("Ilova Hujjatlar kiriting");
                ...
                $('#postFileForm').on('submit', function(event){
                    ...
                    $.ajax({
                        url:"{{ url('/phy/client/create-file') }}",
                        method:"POST",
                ...
                $('#yesFileDelete').click(function () {
                    ...
                    $.ajax(
                        {
                            type: "GET",
                            url: "{{ url('/phy/client/delete-file') }}/"+id,
                            beforeSend: function(){
                                $("#loading-gif").show();
                            },
                            success: function (data) {
            ...
            if ($("#debtorForm").length > 0) {
                $("#debtorForm").validate({
                    submitHandler: function(form) {
                        let actionType = $('#debtor-btn-save').val();

                        $('#debtor-btn-save').html('Sending..');

                        $.ajax({
                            data: $('#debtorForm').serialize(),
                            url: "{{ url('/phy/client-debtors') }}",
                            type: "POST",
                            dataType: 'json',
                            beforeSend: function(){
                                $("#loading-gif").show();
            ...
            // Guar form
            if ($("#postGuarForm").length > 0) {

                $("#postGuarForm").validate({

                    submitHandler: function(form) {

                        let actionType = $('#guar-btn-save').val();

                        $('#guar-btn-save').html('Sending..');

                        $.ajax({
                            data: $('#postGuarForm').serialize(),
                            url: "{{ url('/phy/client/create-guar') }}",
                            type: "POST",
                            dataType: 'json',
                            beforeSend: function(){
                                $("#loading-gif").show();
                            ...
                            success: function (data) {
                                ...
                                $('#guar-btn-save').html('Save Changes');
                                var oTable = $('#guar_datatable').dataTable();
                                oTable.fnDraw(false);
                            },
                            error: function (data) {
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $('#postFileForm').trigger("reset");
                                $('#file-modal').modal('hide');
                                $('#file-btn-save').html('Save Changes');
                                var oTable = $('#file_datatable').dataTable();
                                oTable.fnDraw(false);
                            },
                            error: function (data) {
