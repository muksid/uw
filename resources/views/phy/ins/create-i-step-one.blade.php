        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-primary" style="clear: both;">
                    ...
                    <form action="{{ route('phy.create.step.one.post') }}" method="POST">
                        @csrf
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control" required>
                                                ...
                                                <option value="1" @if(1 == ($model->gender ?? '')) selected @endif>
                                                    Erkak
                                                </option>
                                                <option value="2" @if(2 == ($model->gender ?? '')) selected @endif>
                                                    Ayol
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select name="document_type" class="form-control" required>
                                                <option value="" selected disabled>Tanlang</option>
                                                <option value="6"
                                                        @if(6 == ($model->document_type ?? '')) selected @endif>Passport
                                                </option>
                                                <option value="0"
                                                        @if(7 == ($model->document_type ?? '')) selected @endif>ID karta
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="document_region"
                                                    id="document_region" required>
                                                <option disabled selected value>@lang('blade.select')</option>
                                                @foreach ($regions as $key => $value)
                                                    <option value="{{ $value->code }}"
                                                            @if($value->code == ($model->document_region ?? '')) selected @endif>{{ $value->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"
                                                ...
                                                <option value="1" @if (1 == ($model->is_inps ?? '')) {{ 'selected' }} @endif>
                                                    Bor
                                                </option>
                                                <option value="2" @if (2 == ($model->is_inps ?? '')) {{ 'selected' }} @endif>
                                                    Yo`q
                                                </option>
                                            </select>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="registration_region"
                                                    id="registration_region" required>
                                                <option disabled selected value>@lang('blade.select')</option>
                                                @foreach ($regions as $key => $filial)
                                                    <option value="{{ $filial->code}}"
                                                            @if($filial->code == ($model->registration_region ?? '')) selected="selected" @endif>
                                                        {{ $filial->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"
                                                ...
                                                <option value="1" @if (1 == ($model->live_number ?? '')) {{ 'selected' }} @endif>
                                                    1
                                                </option>
                                                <option value="2" @if (2 == ($model->live_number ?? '')) {{ 'selected' }} @endif>
                                                    2
                                                </option>
                                                <option value="3" @if (3 == ($model->live_number ?? '')) {{ 'selected' }} @endif>
                                                    3
                                                </option>
                                                <option value="4" @if (4 == ($model->live_number ?? '')) {{ 'selected' }} @endif>
                                                    4
                                                </option>
                                                <option value="5" @if (5 == ($model->live_number ?? '')) {{ 'selected' }} @endif>
                                                    5+
                                                </option>
                                            </select>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#registration_region").change(function () {
                    ...
                    let reg_region_code = $(this).val();

                    $.ajax({
                        type: "POST",
                        url: "/madmin/get-reg-districts",
