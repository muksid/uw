                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    ...
                                    <div class="box-header with-border">
                                        <h3>Holati: <span class="label {{ $model->statusIns->bg_style??'-' }}">{{ $model->statusIns->name??'-' }}</span></h3>
                                        @if($modelComments)
                                            <h4 class="text-danger"><i class="fa fa-list-ol"></i> Kredit jarayoni ketma-ketligi</h4>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-light-blue-active">
                        ...
                        <h4 class="modal-title text-center" id="success_inps">Mijoz oylik ish xaqi daromadi <span id="resultDataINPSHeader"></span></h4>
                    </div>
                ...
                $('body').on('click', '#getSalary', function () {
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            $("#resultDataINPSHeader").html(header);
